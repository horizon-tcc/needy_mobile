	...
	return (
		<View>
			...
			<Marker
				...
				title={
					"Colsan Hemocentro Regional de São Bernardo do Campo"
				}
				image={require("../assets/images/telas/telaMaps/sangue.png")}
			/>
			...
			<Marker
				...
				title={
					"A.C.Camargo Cancer Center Castro Alves Assistencial"
				}
				image={require("../assets/images/telas/telaMaps/sangue.png")}
			/>
			...
			<Marker
				...
				title={
					"Banco De Sangue Do Hospital Do Servidor Publico Estadual"
				}
				image={require("../assets/images/telas/telaMaps/sangue.png")}
			/>
